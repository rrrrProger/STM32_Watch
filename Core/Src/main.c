...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, BAT_MEAS_Pin|SD_CS_Pin|GPIO_PIN_12|GPIO_PIN_15, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, PERIPH_EN_Pin|CS_Pin|RESET_Pin|A0_Pin
                          |LED_Pin|SOFT_SPI_SCK_Pin|SOFT_SPI_SDA_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BAT_MEAS_Pin SD_CS_Pin PA12 PA15 */
  GPIO_InitStruct.Pin = BAT_MEAS_Pin|SD_CS_Pin|GPIO_PIN_12|GPIO_PIN_15;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : BTN_4_Pin BTN_3_Pin BTN_1_Pin BTN_2_Pin */
